...
test("org.bouncycastle.tls.crypto.impl.jcajce.srp test vector", async () => {
  const testVector = {
    ...
    M1: "cf5fe5db823c3a24dd41b96945d07ea310e4c5e3430b2b53b2a912c1a37a6fb0",
    M2: "a2148a9fb1b29f2f7f6ce9555243d783d382a5c3778a8515387cec9d782c8abb",
  };
...
test("RFC 5054 test vector", async () => {
  const testVector = {
    ...
    M1: "62c71b289cb22a034b405667e1541202ce5d8e03",
    M2: "b475d7f2d75ce9537748005483e5d326048b59e9",
  };
...
test("PBKDF2 test vector", async () => {
  const testVector = {
    ...
    M1: "ff9a020acfd155cf2f2fe55ad0e790a8efc8191fed94d2adc06b9d1b93669d0d",
    M2: "98e32ab41ae554a4147bd009f21f4417e0ddb80fa6d124cb7ae664da3d383844",
  };
